COURSE_ACTS(COURSE_BOB, _(" 1 HOLY SHIT BOMB WORLD!!!!"),
       _("CUMMING ON THE BOMBS")     , _("FETISH SHARING WITH A TURTLE") , _("SHOOT YOUR GOO EVERYWHERE"),
       _("FIND THE 8 RED DILDOS")          , _("MARIO WINGS TO HEAVEN")        , _("BEHIND CHAIN CHOMP'S BIG BLACK CO-"))

COURSE_ACTS(COURSE_WF, _(" 2 WHOMP'S ASS CAKE"),
       _("CHIP OFF WHOMP'S COCK")        , _("TO THE TOP OF THE DILDO")    , _("SHOOT INTO THE WHITE GOO"),
